...
WebGLRenderingContext.prototype = {
  ...
  ***************************/
  ...
  getAttribLocation : function(program, attr) {
    return program.getAttribLocation(attr);
  },
  enableVertexAttribArray : function(attr) {
  ...
  vertexAttribPointer : function(attr, size, type, normalized, stride, offset) {
    webgl_rendering_context_vertexAttribPointer(attr, size, type, normalized, stride, offset);
  },
  getUniformLocation : function(program, name) {
    return webgl_rendering_context_getUniformLocation(program.id, name);
  },
  ...
  ***************************/
  ...
  pixelStorei : function(param, value) {
  ...
  activeTexture : function(texture_id) {
  ...
  ***************************/
  ...
  bufferData : function(target, array, usage) {
